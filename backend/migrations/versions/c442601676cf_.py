...
Revision ID: c442601676cf
Revises: 
Create Date: 2019-04-21 16:32:47.857883
...
def upgrade():
    ...
    sa.Column('seened', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['group_id'], ['group.id'], ),
    sa.ForeignKeyConstraint(['notification_id'], ['notification.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('user_id', 'group_id', 'notification_id')
    )
    op.create_index(op.f('ix_user_group_notification_seened'), 'user_group_notification', ['seened'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_group_notification_seened'), table_name='user_group_notification')
