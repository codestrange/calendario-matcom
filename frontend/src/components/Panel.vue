                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="list-group">
                            ...
                            <router-link v-for="group in filterList(groups, text, 'name')" :key="group.id" :to="{name: 'editorPage', params: {groupId: group.id}}" class="list-group-item list-group-item-action">{{ group.name }}</router-link>
                        </div>
                    </div>
                </div>
            </div>
